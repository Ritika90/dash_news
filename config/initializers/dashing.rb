...
Dashing.configure do |config|
  ...
  #uri = URI.parse("redis://redistogo:37c8ef97cfaafe6a76ecfb222062e63e@mummichog.redistogo.com:10069/")
  # Redis credentials.
  ...
  # config.widgets_js_path    = 'app/assets/javascripts/dashing/widgets'
  # config.widgets_css_path   = 'app/assets/stylesheets/dashing/widgets'
